...
def get_locale_code(country):
    ...
    return country_locales.get(country, "C.UTF-8")  # Use C.UTF-8 as the default
...
def perform_sorting(file_path, div_class, selected_country):
    ...
    # Replace the content of the file with the sorted data
    with open(file_path, "w", encoding="utf-8") as output_file:
        output_file.write(result_data)
        print("Sorting complete. Changes saved to", file_path)
